...
class ModelType:
    ...
    GPT_4_32k_unavailable = "gpt-4-32k"
    ...
    CHAT_MODELS = [GPT_3_5_TURBO, CHAT_GPT4, FUNCTION_CALLING_GPT4,FUNCTION_CALLING_GPT_3_5, GPT_4_32k_unavailable]
    ...
    MODEL_PRICES = {
        ...
        GPT_4_32k_unavailable: {'input': 0.06, 'output': 0.12},
